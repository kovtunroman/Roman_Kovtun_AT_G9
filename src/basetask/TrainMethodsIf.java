...
public class TrainMethodsIf {
    public int returnNewInt(int inputNumber) { return (inputNumber < 8) ? (inputNumber * 7) : (inputNumber / 4); }
    public long returnNewLong(int inputNumber) { return (inputNumber > 300) ? (inputNumber - 300) : (inputNumber + 20); }
    ...
    public float returnNewFloat(float inputNumber) { return (inputNumber == 0.67) ? inputNumber : (inputNumber * 2); }
